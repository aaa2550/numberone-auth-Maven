 --省级 province
--城市 city
create table province(pid int,province varchar(50),primary key (pid))
...
create table city(cid int not null,city varchar(50) primary key,pid int foreign key references province(pid))
----------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------
--插入各个省的城市数据
--4个直辖市
