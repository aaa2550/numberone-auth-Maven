...
import com.numberONe.entity.CustomerRebatesInfoFormMap;
...
import com.numberONe.mapper.CustomerRebatesInfoMapper;
...
public class CustomerRebatesInfoController extends BaseController {

    private static final Logger logger = LoggerFactory.getLogger(CustomerRebatesInfoController.class);

    @Inject
    private CustomerRebatesInfoMapper providerRebatesInfoMapper;
	...
	public PageView findByPage( String pageNow,
        ...
        CustomerRebatesInfoFormMap providerRebatesInfoFormMap = getFormMap(CustomerRebatesInfoFormMap.class);
        String order = "";
    ...
    public String editUI(Model model) throws Exception {
        ...
        if(Common.isNotEmpty(id)){
            model.addAttribute("providerRebatesInfo", providerRebatesInfoMapper.findbyFrist("id", id, CustomerRebatesInfoFormMap.class));
        }
    ...
    public CodeMsg editEntity(Model model) throws Exception {
        CustomerRebatesInfoFormMap providerRebatesInfoFormMap = null;
        try {
            providerRebatesInfoFormMap = getFormMap(CustomerRebatesInfoFormMap.class);
    ...
    public CodeMsg deleteEntity(Model model) throws Exception {
        try {
            ...
            for (String id : ids) {
                providerRebatesInfoMapper.deleteByAttribute("id", id, CustomerRebatesInfoFormMap.class);
            };
            return CodeMsg.SUCCESS;
        } catch (Throwable e) {
