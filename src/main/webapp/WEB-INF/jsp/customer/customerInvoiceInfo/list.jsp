...
<script type="text/javascript">
    ...
    $(function() {
        ...
        grid = lyGrid({
            ...
            l_column : [ {
                ...
                colkey : "openAccountBank",
                name : "开户银行"
            },{
                colkey : "accountCode",
                name : "银行账户号"
            }],
            jsonUrl : rootPath + '/customer/customerInvoiceInfo/findByPage.shtml',
            checkbox : true,
            serNumber : true
        });
    ...
    function editFunction() {
        ...
        pageii = layer.open({
            ...
            type : 2,
            area : [ "600px", "80%" ],
            content : rootPath + '/customer/customerInvoiceInfo/editUI.shtml?id=' + cbox
        });
    }
    function addFunction() {
        pageii = layer.open({
            ...
            type : 2,
            area : [ "600px", "80%" ],
            content : rootPath + '/customer/customerInvoiceInfo/editUI.shtml'
        });
    }
    ...
    function deleteFunction() {
        ...
        layer.confirm('是否删除？', function(index) {
            var url = rootPath + '/customer/customerInvoiceInfo/deleteEntity.shtml';
...
<div class="m-b-md">
    <form class="form-inline" role="form" id="searchForm"
        ...
        <div class="form-group">
            ...
            name="customerInvoiceInfoFormMap.statisticsShortName">
        </div>
