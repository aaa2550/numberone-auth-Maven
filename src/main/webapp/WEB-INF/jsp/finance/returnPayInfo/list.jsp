...
<%--<script type="text/javascript" src="${pageContext.request.contextPath}/js/finance/returnPayInfo/list.js"></script>--%>
<script type="text/javascript">
    ...
    $(function() {
        ...
        grid = lyGrid({
            ...
            l_column : [{
                ...
                colkey : "openAccountInstitutions",
                name : "对方开户机构"
            },{
                colkey : "bankRecordTime",
                name : "记账日期"
            },{
                colkey : "abstracts",
                name : "摘要"
                ...
                colkey : "voucherSpecies",
                name : "凭证种类"
            },{
                colkey : "voucherCode",
                name : "凭证号"
            }],
            jsonUrl : rootPath + '/finance/returnPayInfo/findByPage.shtml',
            checkbox : true,
            serNumber : true
        });
    ...
    function editFunction() {
        ...
        pageii = layer.open({
            ...
            type : 2,
            area : [ "600px", "80%" ],
            content : rootPath + '/finance/returnPayInfo/editUI.shtml?id=' + cbox
        });
    }
    function addFunction() {
        pageii = layer.open({
            ...
            type : 2,
            area : [ "600px", "80%" ],
            content : rootPath + '/finance/returnPayInfo/editUI.shtml'
        });
    }
    ...
    function deleteFunction() {
        ...
        layer.confirm('是否删除？', function(index) {
            var url = rootPath + '/finance/returnPayInfo/deleteEntity.shtml';
