...
<script type="text/javascript">
    ...
    $(function() {
        ...
        grid = lyGrid({
            ...
            jsonUrl : rootPath + '/provider/providerInvoiceInfo/findByPage.shtml',
            checkbox : true,
            serNumber : true
        });
    ...
    function editFunction() {
        ...
        pageii = layer.open({
            ...
            type : 2,
            area : [ "600px", "80%" ],
            content : rootPath + '/provider/providerInvoiceInfo/editUI.shtml?id=' + cbox
        });
    }
    function addFunction() {
        pageii = layer.open({
            ...
            type : 2,
            area : [ "600px", "80%" ],
            content : rootPath + '/provider/providerInvoiceInfo/editUI.shtml'
        });
    }
    ...
    function deleteFunction() {
        ...
        layer.confirm('是否删除？', function(index) {
            var url = rootPath + '/provider/providerInvoiceInfo/deleteEntity.shtml';
...
<div class="m-b-md">
    <form class="form-inline" role="form" id="searchForm"
        ...
        <div class="form-group">
            ...
            name="providerInvoiceInfoFormMap.statisticsShortName">
        </div>
