...
<%--<script type="text/javascript" src="${pageContext.request.contextPath}/js/provider/providerInvoiceRecord/list.js"></script>--%>
...
<div class="m-b-md">
    <form class="form-inline" role="form" id="searchForm"
        ...
        <div class="form-group">
            ...
            name="providerContractInfoFormMap.statisticsShortName">
        </div>
