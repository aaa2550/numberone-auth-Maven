...
<head>
    ...
    <%--<script type="text/javascript" src="${ctx}/js/provider/providerRebatesInfo/add.js"></script>--%>
    <style type="text/css">
        #but button {
            margin-bottom: 5px;
            margin-right: 5px;
    ...
    <script type="text/javascript">
        ...
        function init() {
            $("#providerType").val("${providerRebatesInfo.providerType}");
            $("#businessType").val("${providerRebatesInfo.businessType}");
        }
    </script>
</head>
<body>
...
<form id="form" name="form" class="form-horizontal" method="post"
      action="${pageContext.request.contextPath}/provider/providerRebatesInfo/editEntity.shtml">
    <input type="hidden" class="form-control checkacc"
           value="${providerRebatesInfo.id}" name="providerRebatesInfoFormMap.id" id="id">
