...
<%--<script type="text/javascript" src="${pageContext.request.contextPath}/js/provider/providerRebatesInfo/list.js"></script>--%>
<script type="text/javascript">
    ...
    $(function() {
        ...
        grid = lyGrid({
            ...
            jsonUrl : rootPath + '/provider/providerRebatesInfo/findByPage.shtml',
            checkbox : true,
            serNumber : true
        });
    ...
    function editFunction() {
        ...
        pageii = layer.open({
            ...
            type : 2,
            area : [ "600px", "80%" ],
            content : rootPath + '/provider/providerRebatesInfo/editUI.shtml?id=' + cbox
        });
    }
    function addFunction() {
        pageii = layer.open({
            ...
            type : 2,
            area : [ "600px", "80%" ],
            content : rootPath + '/provider/providerRebatesInfo/editUI.shtml'
        });
    }
    ...
    function deleteFunction() {
        ...
        layer.confirm('是否删除？', function(index) {
            var url = rootPath + '/provider/providerRebatesInfo/deleteEntity.shtml';
...
<div class="m-b-md">
    <form class="form-inline" role="form" id="searchForm"
        ...
        <div class="form-group">
            ...
            name="providerRebatesInfoFormMap.statisticsShortName">
        </div>
